  ...
  return (
    <div className="onboard-container">
      <div className="onboard-card" style={{ maxWidth: '420px' }}>
        ...
        <h2 style={{ textAlign: 'center', marginBottom: '0.5rem', fontSize: '1.3rem' }}>Welcome back</h2>
        <p style={{ textAlign: 'center', marginBottom: '2rem', fontSize: '0.9rem' }}>Sign in to your founder workspace</p>
        ...
        <p style={{ textAlign: 'center', marginTop: '0.75rem', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
          Or{' '}
          <Link to="/onboarding" style={{ color: 'var(--secondary)', fontWeight: 500, textDecoration: 'none' }}>
            continue as guest (quick onboarding)
          </Link>
        </p>
      </div>
    </div>
