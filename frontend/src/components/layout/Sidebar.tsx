...
const Sidebar: React.FC<SidebarProps> = ({ validationReports, roadmapTasks }) => {
  ...
  const menuItems = [
    ...
    { id: 'roadmap', path: '/roadmap', label: 'Roadmap', icon: Map, badge: totalTasks > 0 ? `${completedTasks}/${totalTasks}` : null },
    { id: 'investors', path: '/investors', label: 'Investor Directory', icon: Coins, badge: null },
    { id: 'mentors', path: '/mentors', label: 'Mentor Board', icon: Users, badge: null },
    { id: 'pitch-review', path: '/pitch-review', label: 'Pitch Deck Review', icon: Activity, badge: null },
    { id: 'playbooks', path: '/playbooks', label: 'Playbook Library', icon: Zap, badge: null },
    { id: 'network', path: '/network', label: 'Network Hub', icon: Users, badge: null },
        ...
        {profile.registered && (
          <div className="sidebar-footer">
            ...
            >
              ...
              <span style={{ color: 'var(--danger)', fontWeight: 600 }}>Sign Out / Reset</span>
            </button>
