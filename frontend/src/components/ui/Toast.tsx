...
let addToastGlobal: ((toast: Toast) => void) | null = null;
...
export default function ToastContainer() {
  ...
  return (
    <div style={{
      ...
      gap: '0.75rem', pointerEvents: 'none', maxWidth: '400px'
    }}>
      {toasts.map((toast) => {
        ...
        return (
          <div key={toast.id} className="slide-up" style={{
            ...
            background: colors.bg, backdropFilter: 'blur(16px)',
            border: `1px solid ${colors.border}`, borderRadius: '10px',
            color: colors.color, fontSize: '0.88rem', fontWeight: 500,
            ...
            <button onClick={() => removeToast(toast.id)} style={{
              ...
              cursor: 'pointer', padding: '2px', opacity: 0.6, flexShrink: 0
            }}>
              <X size={14} />
            </button>
          </div>
